namespace AntShares.Core.Scripts
{
    export class ScriptBuilder
    {
        ...
        public push(data: number | UintVariable | ArrayBuffer | ArrayBufferView): ScriptBuilder
        {
            ...
            else if (data instanceof UintVariable)
            {
                return this.push(data.bits);
            }
            else
            {
